...
function hToggle() {
    ...
    document.getElementById('hiragana-label').classList.toggle('hidden');

    if (document.getElementById('hiragana-label').classList.contains('hidden')) {
        document.getElementById("kSpan").style.transform = "translateX(-20%)";
    }
    else {
        document.getElementById("kSpan").style.transform = "";
    }
...
function kToggle() {
    ...
    document.getElementById('katakana-label').classList.toggle('hidden');
    if (document.getElementById('katakana-label').classList.contains('hidden')) {
        document.getElementById('hSpan').style.transform = "translateX(-20%)";
    }
    else {
        document.getElementById('hSpan').style.transform = "";
    }
}
